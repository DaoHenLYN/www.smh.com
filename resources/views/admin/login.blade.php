  ...
  <div id="loginform" class="loginBox">
    ...
    {{ csrf_field() }}
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="1" name="username" type="text" value="{{old('username')}}" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="password" type="password" value="{{old('username')}}" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
          <div class="formControls col-xs-8 col-xs-offset-3">
            ...
            <img src="{{ URL('admin/captcha/1') }}" id="captchaid"><a onclick="javascript:re_captcha();" href="javascript:;">看不清，换一张</a> 
          </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
...
<div class="footer">个人学习，仅供娱乐</div>
